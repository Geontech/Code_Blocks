...
Requires: DataConverter sawcontrol
BuildArch: noarch
...
%__install -m 644 controller.sad.xml $RPM_BUILD_ROOT%{_prefix}/dom/waveforms/%{name}/controller.sad.xml

%files
%defattr(-,redhawk,redhawk)
%dir %{_prefix}/dom/waveforms/%{name}
%{_prefix}/dom/waveforms/%{name}/controller.sad.xml
