...
pushd python
./reconf
%define _bindir %{_prefix}/dev/devices/simple_gps/python
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dev/devices/%{name}/simple_gps.scd.xml
%{_prefix}/dev/devices/%{name}/simple_gps.prf.xml
%{_prefix}/dev/devices/%{name}/simple_gps.spd.xml
